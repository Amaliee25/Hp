...
public class SlackPartOauth extends BaseSlackPart {
     ...
     * @param callback
     */
    public void access(@NonNull String clientId, @NonNull String clientSecret, @NonNull String code, Callback<OauthAccessResponse> callback){
        access(clientId, clientSecret, code, null, callback);
    }
     ...
     * @param callback
     */
    public void access(@NonNull String clientId, @NonNull String clientSecret, @NonNull String code,
                       @NonNull OauthAccessParams params, Callback<OauthAccessResponse> callback){
        service.oauthAccess(clientId, clientSecret, code, verifyParams(params)).enqueue(callback);
    }
}
